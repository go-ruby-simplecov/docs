...
The public API lives at the module root (`github.com/go-ruby-simplecov/simplecov`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `simplecov`, while the surface follows
...
```go
import "github.com/go-ruby-simplecov/simplecov"
```
...
- **[pkg.go.dev/github.com/go-ruby-simplecov/simplecov](https://pkg.go.dev/github.com/go-ruby-simplecov/simplecov)**

The module's [README](https://github.com/go-ruby-simplecov/simplecov#readme) carries worked
