# go-ruby-simplecov documentation

**Pure-Go SimpleCov: coverage result engine (merge/filter/group/thresholds), CGO=0 — bound into rbgo**

`go-ruby-simplecov/simplecov` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `simplecov`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-simplecov/simplecov`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `simplecov`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`simplecov`](https://github.com/go-ruby-simplecov/simplecov) | the library — Ruby's `simplecov` in pure Go |
| [`docs`](https://github.com/go-ruby-simplecov/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-simplecov.github.io`](https://github.com/go-ruby-simplecov/go-ruby-simplecov.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-simplecov/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-simplecov/simplecov](https://github.com/go-ruby-simplecov/simplecov).
