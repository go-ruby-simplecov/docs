...
Contributions are welcome. `go-ruby-simplecov/simplecov` is built to a small set of
...
The library is in [`github.com/go-ruby-simplecov/simplecov`](https://github.com/go-ruby-simplecov/simplecov).
This documentation site is in [`github.com/go-ruby-simplecov/docs`](https://github.com/go-ruby-simplecov/docs).
